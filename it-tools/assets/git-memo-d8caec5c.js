import{o,f as s,ai as r,d as l,ag as i,bC as m,k as p,i as a,D as g}from"./index-58898efa.js";const d={class:"markdown-body"},h=r(`<h2>Configuration</h2><p>Set the global config</p><pre><code class="language-shell">git config --global user.name &quot;[name]&quot;
...
</code></pre>`,27),_=[h],u={__name:"git-memo.content",setup(c,{expose:e}){return e({frontmatter:{}}),(n,b)=>(o(),s("div",d,_))}},f=l({__name:"git-memo",setup(c){i(t=>({"8cb22b3c":a(e).cardColor}));const e=m();return(t,n)=>(o(),s("div",null,[p(a(u))]))}});const k=g(f,[["__scopeId","data-v-c7dbeca3"]]);export{k as default};
